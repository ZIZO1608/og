/* ==========================================================================
   ...
   --------------------------------------------------------------------------
   Two jobs, and neither writes a single row of shop data:
   ...
   (deploy/shop-proxy/), which routes /snapshot here and nothing else. It is
   never given a public domain of its own in Coolify.
   ========================================================================== */
