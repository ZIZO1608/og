...
var EXTRA_V3_EN = {
  ...
  mir_pull_unpushed_local: '{n} change(s) here never reached the cloud, which now belongs to {host} — run claim-mirror.bat to keep them',
  ...
  mir_pull_warning_claim_failed: 'pulled, but the cloud could not be claimed — run claim-mirror.bat',
...
var EXTRA_V3_AR = {
  ...
  mir_pull_unpushed_local: '{n} تغيير هنا لم يصل إلى السحابة، وهي الآن تعود إلى {host} — شغّل claim-mirror.bat للاحتفاظ بها',
  ...
  mir_pull_warning_claim_failed: 'تم السحب، لكن تعذّر امتلاك السحابة — شغّل claim-mirror.bat',
