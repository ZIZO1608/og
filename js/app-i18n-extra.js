...
var EXTRA_EN = {
  ...
  tour_hint: 'Walk through the whole app screen by screen — a sale, the stock dropping, the invoice, the numbers.',
...
var EXTRA_AR = {
  ...
  tour_hint: 'جولة على كامل التطبيق شاشة بشاشة — عملية بيع، نقص المخزون، الفاتورة، والأرقام.',
