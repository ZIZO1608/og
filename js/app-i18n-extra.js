...
var EXTRA_V3_EN = {
  ...
  setg_people: 'People and access', setg_system: 'System',
  ...
  mir_note: 'A copy of the shop kept in Supabase for the day this machine dies. Every change goes up a few seconds after it happens; a full pass runs on a timer to heal anything missed. Only this computer sends to it, and nothing ever comes back down by itself — it is read back only when the shop is restored onto a new laptop.',
  ...
  mir_refused: 'This computer isn’t the shop. It can’t send to the cloud copy.',
  mir_refused_by: 'The cloud copy belongs to {host}. Everything done here stays on this computer.',
  mir_nobody: 'The cloud copy has been written to before and no computer owns it yet.',
...
var EXTRA_V3_AR = {
  ...
  setg_people: 'الموظفون والصلاحيات', setg_system: 'النظام',
  ...
  mir_note: 'نسخة من المحل محفوظة في Supabase ليوم يتعطّل فيه هذا الجهاز. كل تغيير يُرفع بعد ثوانٍ من حدوثه، وتعمل جولة كاملة على مؤقّت لإصلاح أي شيء فات. هذا الكمبيوتر وحده بيبعت لها، وما بينزل منها شي لحاله — بتنقرا بس وقت استرجاع المحل على لابتوب جديد.',
  ...
  mir_refused: 'هذا الكمبيوتر مو كمبيوتر المحل. ما بيقدر يبعت للنسخة السحابية.',
  mir_refused_by: 'النسخة السحابية تابعة لـ {host}. كل شي بينعمل هون بيضل على هذا الكمبيوتر.',
  mir_nobody: 'النسخة السحابية انكتب عليها من قبل، وما في كمبيوتر مالكها لسا.',
...
var COLOURS_EN = {
  ...
  cl_photo_add: 'Add a photo', cl_total: 'In this colour', cl_grand: 'Everything',
...
var COLOURS_AR = {
  ...
  cl_photo_add: 'أضف صورة', cl_total: 'في هذا اللون', cl_grand: 'المجموع',
...
var SAFEERS_EN = {
  ...
  sf_assign_parcel: 'Give a parcel', sf_new_errand: 'New errand',
  sf_offline: 'Cannot reach the shop. Connect to the shop wifi to update the tasks.',
  sf_failed: 'The team could not be loaded.',
  sf_no_team: 'No safeers yet', sf_no_team_sub: 'They sign in with their own username.',
  sf_no_team_ask: 'Ask the manager to add one.', sf_loading: 'Loading the team…',
  sf_off: 'Switched off', sf_busy: 'On a task', sf_free: 'Free',
  sf_open: 'Open tasks', sf_done_today: 'Done today',
  sf_earned: 'Earned today', sf_week: 'week', sf_month: 'month', sf_cash_on_him: 'Cash on him',
  sf_done_week: 'This week {n}', sf_done_month: 'This month {n}',
  sf_earned_week: 'week {n}', sf_earned_month: 'month {n}',
  sf_wa: 'WhatsApp', sf_hand_in: 'Take it in →',
  sf_phone_set: 'Phone number', sf_phone_saved: 'Number saved',
  sf_phone_hint: 'This is the number Call and WhatsApp use. Leave it empty to remove it.',
  err_bad_phone: 'That does not look like a phone number.',
  sf_mine_none: 'No tasks for you right now.', sf_mine_none_sub: 'A new one shows up here by itself.',
...
var SAFEERS_AR = {
  ...
  sf_assign_parcel: 'أعطِ طرداً', sf_new_errand: 'مهمة جديدة',
  sf_offline: 'لا يمكن الوصول إلى المحل. اتصل بشبكة المحل لتحديث المهام.',
  sf_failed: 'تعذّر تحميل الفريق.',
  sf_no_team: 'لا يوجد سفراء بعد', sf_no_team_sub: 'بيفوت باسم المستخدم تبعه.',
  sf_no_team_ask: 'خبّر المدير ليضيف واحد.', sf_loading: 'عم نجيب الفريق…',
  sf_off: 'موقوف', sf_busy: 'في مهمة', sf_free: 'متفرّغ',
  sf_open: 'مهام مفتوحة', sf_done_today: 'أُنجز اليوم',
  sf_earned: 'أجر اليوم', sf_week: 'الأسبوع', sf_month: 'الشهر', sf_cash_on_him: 'النقد معه',
  sf_done_week: 'هالأسبوع {n}', sf_done_month: 'هالشهر {n}',
  sf_earned_week: 'الأسبوع {n}', sf_earned_month: 'الشهر {n}',
  sf_wa: 'واتساب', sf_hand_in: 'استلام النقد ←',
  sf_phone_set: 'رقم الموبايل', sf_phone_saved: 'انحفظ الرقم',
  sf_phone_hint: 'هاد الرقم يلي بيستخدمه الاتصال والواتساب. اتركه فاضي لتشيله.',
  err_bad_phone: 'هاد مو رقم موبايل.',
  sf_mine_none: 'ما في مهام إلك هلق.', sf_mine_none_sub: 'أي مهمة جديدة بتظهر هون لحالها.',
...
var NS03_EN = {
  ...
  cb_amount: 'How much?',
  cb_no_line: 'Not saved — check the connection and try again.',
  cb_today: 'Today',
  cb_today_none: 'Nothing has moved today.',
  cb_today_more: 'All of it in Money history →',
  cb_today_cap: 'The latest {n} of {t} today',
  cb_t_in: '{a} came into {p} — {w}',
  cb_t_out: '{a} left {p} — {w}',
  ...
  pr_select: 'Select',
  pr_scan_found: '{n} products match that code',
  pr_scan_none: 'Nothing here matches that code',
  cl_print_q: 'Print labels for these? {n} pieces went onto the shelf.',
  cl_print_why: 'A box with no sticker on it cannot be scanned — not at the till, not in the back room.',
  cl_print_later: 'Not now',
  cl_print_now: 'Print {n} labels',
  pr_price_was: 'Was {was} — it becomes {now}.',
  pr_stop_shop: 'It leaves the Products list and every stock figure.',
  pr_stop_web: 'It comes off the website, whatever its website switch says.',
  pr_stop_keep: 'Nothing is deleted. Every old invoice still names it, and the stock it has stays where it is.',
  pr_stopped: 'Stopped. It is off the shop and off the website.',
  pr_resumed: 'Back on sale — its website switch is where you left it.',

  /* -- settings, regrouped -- */
  set_saves_itself: 'Everything here saves the moment you change it',
  setg_money: 'Money and prices',
  setg_deliv: 'Deliveries',
  setg_advanced: 'Advanced',
  setg_advanced_sub: 'The cloud copy, the bots and the reminders. These can break the shop.',
  setg_this_machine: 'This machine',
  set_brand_sub: 'The name, the phone and the address printed on every receipt and invoice.',
  set_brand_where: 'These four are what the receipt and the A4 invoice print at the top.',
  set_rate_sub: 'Every dollar price in the shop converts through this one number.',
  set_rate_live: 'every price in the system updates at once',
  set_ship_sub: 'What the shop charges to send a parcel. An order stalls until this list has the city in it.',
  set_ship_empty: 'The list is empty, so every order stops on "Say what the shipping is". Fill it once.',
  set_ship_add: '+ Add a city',
  set_ship_del: 'Remove',

  /* -- the people -- */
  st_people_sub: 'Who can sign in, what each of them does, and their passwords.',
  st_pw_made: 'A password is made for them and shown once, here, with a Copy button.',
  st_d_sell: 'sells at the till',
  st_d_desk: 'takes orders at the desk',
  st_d_stock: 'moves and receives stock',
  st_d_products: 'adds and edits products',
  st_d_carry: 'carries the parcels',
  st_d_count: 'counts the drawer',
  st_d_money: 'moves the shop money',
  st_d_reports: 'reads the reports',
  st_d_people: 'manages the people',
  st_d_nothing: 'nothing yet — open what they need afterwards',
  st_off_parcels: '{n} parcel(s) still out or waiting',
  st_off_errands: '{n} errand(s) not finished',
  st_off_shift: 'the drawer is open under their name',
  st_off_cash: '{x} of the shop money is on them',
  st_off_clean: '{name} is holding nothing open.',
  st_off_what: 'They can no longer sign in. Their history stays, and anything still waiting is left with nobody until somebody gives it out again.',
  st_off_reassign_hint: 'Give the parcels to somebody else first — the board is where that happens, and it knows what else is going out today.',
...
var NS03_AR = {
  ...
  cb_amount: 'قديش؟',
  cb_no_line: 'ما انحفظ — شوف الاتصال وجرّب كمان مرة.',
  cb_today: 'اليوم',
  cb_today_none: 'ما تحرّك شي اليوم.',
  cb_today_more: 'الكل بسجل المصاري ←',
  cb_today_cap: 'آخر {n} من {t} اليوم',
  cb_t_in: '{a} دخلت على {p} — {w}',
  cb_t_out: '{a} طلعت من {p} — {w}',
  ...
  pr_select: 'اختار',
  pr_scan_found: 'في {n} منتجات مطابقة للكود',
  pr_scan_none: 'ما في شي هون مطابق لهالكود',
  cl_print_q: 'نطبع ليبلات لهدول؟ {n} قطعة نزلت عالرف.',
  cl_print_why: 'الكرتونة بلا ليبل ما بتنقرأ بالماسح — لا عالكاشير ولا بالمستودع.',
  cl_print_later: 'مو هلق',
  cl_print_now: 'اطبع {n} ليبل',
  pr_price_was: 'كان {was} — بيصير {now}.',
  pr_stop_shop: 'بيطلع من قائمة المنتجات ومن كل أرقام المخزون.',
  pr_stop_web: 'وبينشال عن الموقع، مهما كان مفتاح الموقع تبعو.',
  pr_stop_keep: 'ما في شي بينحذف. كل فاتورة قديمة بتضل تسميه، والكمية يللي عندو بتضل مطرحها.',
  pr_stopped: 'وقّفناه. مو بالمحل ولا عالموقع.',
  pr_resumed: 'رجع للبيع — ومفتاح الموقع متل ما تركتو.',

  /* -- الإعدادات -- */
  set_saves_itself: 'كل شي هون بينحفظ أول ما تغيّرو',
  setg_money: 'المصاري والأسعار',
  setg_deliv: 'التوصيل',
  setg_advanced: 'متقدّم',
  setg_advanced_sub: 'النسخة السحابية والبوتات والتذكيرات. هدول بيقدروا يوقفوا المحل.',
  setg_this_machine: 'هالجهاز',
  set_brand_sub: 'الاسم والتلفون والعنوان يللي بينطبعوا على كل فاتورة.',
  set_brand_where: 'هدول الأربعة هنّ يللي بتطبعهن الفاتورة الحرارية وفاتورة A4 بالأعلى.',
  set_rate_sub: 'كل سعر بالدولار بالمحل بينحسب من هالرقم لحالو.',
  set_rate_live: 'كل الأسعار بالنظام بتتحدّث فوراً',
  set_ship_sub: 'شو بياخد المحل ليوصّل طرد. الطلب بيوقف لحد ما تكون المدينة بهاللستة.',
  set_ship_empty: 'اللستة فاضية، فكل طلب بيوقف على "حدّد أجرة التوصيل". عبّيها مرة وحدة.',
  set_ship_add: '+ ضيف مدينة',
  set_ship_del: 'شيلها',

  /* -- الموظفون -- */
  st_people_sub: 'مين فيه يفوت، وشو بيشتغل كل واحد، وكلمات السر.',
  st_pw_made: 'منعملّو كلمة سر وبتنعرض مرة وحدة هون، مع زر نسخ.',
  st_d_sell: 'بيبيع عالكاشير',
  st_d_desk: 'بياخد الطلبات',
  st_d_stock: 'بينقل ويستلم البضاعة',
  st_d_products: 'بيضيف ويعدّل المنتجات',
  st_d_carry: 'بيوصّل الطرود',
  st_d_count: 'بيعدّ الصندوق',
  st_d_money: 'بيحرّك مصاري المحل',
  st_d_reports: 'بيقرا التقارير',
  st_d_people: 'بيدير الموظفين',
  st_d_nothing: 'ولا شي لهلق — افتحلو يللي بدو ياه بعدين',
  st_off_parcels: 'في {n} طرد لسا برّا أو منتظر',
  st_off_errands: 'في {n} مشوار ما خلص',
  st_off_cash: 'معو {x} من مصاري المحل',
  st_off_shift: 'الصندوق مفتوح باسمو',
  st_off_clean: '{name} ما معو شي مفتوح.',
  st_off_what: 'ما رح يقدر يفوت بعد هلق. تاريخو بيضل، وكل شي لسا منتظر بيضل بلا حدا لحد ما حدا يعطيه لغيرو.',
  st_off_reassign_hint: 'عطي الطرود لحدا تاني أول شي — لوحة التوصيل هي المطرح، وهي بتعرف شو طالع اليوم كمان.',
...
/* ---- Website orders (js/weborders.js, server/lib/weborders.js) -----------
   Orders placed on the website, waiting for a phone call and a yes or no.
   The reasons (wo_code_*) are the website's own list too — the customer is
   shown the same reason in their language (docs/website/PROMPT-FOR-AHMAD.md). */
var WEBORDERS_EN = {
  nav_weborders: 'Website orders',
  wo_title: 'Website orders',
  wo_sub: 'Orders from the website. Call the customer, then accept or reject.',
  wo_refresh: 'Refresh',
  wo_tab_new: 'New', wo_tab_accepted: 'Accepted', wo_tab_rejected: 'Rejected',
  wo_loading: 'Loading the website orders…',
  wo_empty_new: 'No new website orders.',
  wo_empty_accepted: 'No accepted website orders yet.',
  wo_empty_rejected: 'No rejected website orders.',
  wo_empty_why: 'Orders arrive by themselves every minute while the shop is open.',
  wo_capped: 'Showing the latest 80 only.',
  wo_test: 'Test',
  wo_placed: 'Placed',
  wo_customer: 'Customer',
  wo_known: 'Known customer: {name}',
  wo_new_customer: 'New customer',
  wo_call: 'Call',
  wo_whatsapp: 'WhatsApp',
  wo_delivery: 'Delivery',
  wo_pickup: 'Picks it up from the shop',
  wo_recipient: 'Receiver',
  wo_payment: 'Payment',
  wo_pay_transfer: 'Transfer',
  wo_pay_cod: 'Cash on delivery',
  wo_txn: 'Transfer no.',
  wo_proof_open: 'Open the receipt photo',
  wo_no_proof: 'No receipt photo yet',
  wo_note: 'Customer’s note',
  wo_items: 'Products',
  wo_unknown_sku: 'Code {sku} is not in the shop — ask the customer',
  wo_in_stock: '{n} in stock here',
  wo_short: 'Only {n} here · {all} in all places',
  wo_archived: 'This product is no longer sold',
  wo_shown: 'Website showed:',
  wo_prints: 'Printing',
  wo_prints_sent_note: 'Sent to Yalla Wear by itself when the order arrived.',
  wo_no_name: 'No name',
  wo_print_test: 'Test order — not sent to Yalla Wear',
  wo_print_not_sent: 'Not sent to Yalla Wear',
  wo_print_declined: 'Yalla Wear declined',
  wo_print_draft: 'Names missing — finish it on the Print screen',
  wo_print_waiting: 'Waiting for Yalla Wear to accept',
  wo_print_error: 'Not sent:',
  wo_st_design: 'Design', wo_st_sent: 'At the print shop', wo_st_printing: 'Printing',
  wo_st_delivery: 'On its way to the shop', wo_st_done: 'Ready',
  wo_open_job: 'Open',
  wo_accept: 'Accept',
  wo_opening: 'Opening…',
  wo_reject: 'Reject',
  wo_test_why: 'A test order can never become a real order. Reject it when you are done.',
  wo_accept_needs_desk: 'To accept, your account needs the delivery office — the owner turns it on in Settings → Access.',
  perm_delivery_web: 'See and answer website orders',
  wo_accepted_by: 'Accepted by {who} · {when}',
  wo_rejected_by: 'Rejected by {who} · {when}',
  wo_open_order: 'Open the order',
  wo_reject_title: 'Reject order {ref}',
  wo_reject_note: 'The customer sees the reason on their order page on the website. Print jobs already sent to Yalla Wear are not cancelled by this.',
  wo_reject_why: 'Note for the shop (optional)',
  wo_rejected_toast: 'Order {ref} rejected.',
  wo_code_no_answer: 'No answer on the phone',
  wo_code_out_of_stock: 'Sold out',
  wo_code_customer_cancelled: 'Customer cancelled',
  wo_code_unpaid: 'Transfer never arrived',
  wo_code_duplicate: 'Duplicate order',
  wo_code_test: 'Test order',
  wo_code_other: 'Other reason',
  wo_proof_title: 'Transfer receipt — {ref}',
  wo_desk_note: 'Website order {ref}',
  wo_desk_skipped: '{n} unknown product(s) left out — ask the customer.',
  al_web_new: '{n} website orders waiting',
  al_web_new_1: '1 website order waiting',
  set_webprint: 'Website print price',
  set_webprint_unset: 'Not set',
  set_webprint_sub: 'What one printed piece (a name and number on a shirt) costs a website customer.',
  set_webprint_label: 'Price of one piece, in lira',
  set_webprint_note: 'The website shows this price, and print jobs from the website are recorded at it. The till’s own print price is separate.'
};
var WEBORDERS_AR = {
  nav_weborders: 'طلبات الموقع',
  wo_title: 'طلبات الموقع',
  wo_sub: 'الطلبات يلي إجت من الموقع. اتصل بالزبون، وبعدين اقبل أو ارفض.',
  wo_refresh: 'تحديث',
  wo_tab_new: 'جديدة', wo_tab_accepted: 'مقبولة', wo_tab_rejected: 'مرفوضة',
  wo_loading: 'عم نحمّل طلبات الموقع…',
  wo_empty_new: 'ما في طلبات جديدة من الموقع.',
  wo_empty_accepted: 'ما في طلبات مقبولة لسّا.',
  wo_empty_rejected: 'ما في طلبات مرفوضة.',
  wo_empty_why: 'الطلبات بتوصل لحالها كل دقيقة طالما المحل شغّال.',
  wo_capped: 'عم نعرض أحدث 80 طلب بس.',
  wo_test: 'تجربة',
  wo_placed: 'انطلب',
  wo_customer: 'الزبون',
  wo_known: 'زبون معروف: {name}',
  wo_new_customer: 'زبون جديد',
  wo_call: 'اتصال',
  wo_whatsapp: 'واتساب',
  wo_delivery: 'التوصيل',
  wo_pickup: 'بيستلمه من المحل',
  wo_recipient: 'المستلم',
  wo_payment: 'الدفع',
  wo_pay_transfer: 'تحويل',
  wo_pay_cod: 'كاش عند الاستلام',
  wo_txn: 'رقم التحويل',
  wo_proof_open: 'افتح صورة الإيصال',
  wo_no_proof: 'لسّا ما بعت صورة الإيصال',
  wo_note: 'ملاحظة الزبون',
  wo_items: 'المنتجات',
  wo_unknown_sku: 'الكود {sku} مو موجود عنا — اسأل الزبون',
  wo_in_stock: '{n} موجودين هون',
  wo_short: 'بس {n} هون · {all} بكل الأماكن',
  wo_archived: 'هالمنتج موقّف بيعه',
  wo_shown: 'الموقع عرض:',
  wo_prints: 'الطباعة',
  wo_prints_sent_note: 'انبعتت ليالا وير لحالها لما وصل الطلب.',
  wo_no_name: 'بلا اسم',
  wo_print_test: 'طلب تجربة — ما انبعت ليالا وير',
  wo_print_not_sent: 'ما انبعت ليالا وير',
  wo_print_declined: 'يالا وير ما قبلت',
  wo_print_draft: 'ناقصه أسماء — كمّله من شاشة الطباعة',
  wo_print_waiting: 'بانتظار يالا وير تقبل',
  wo_print_error: 'ما انبعت:',
  wo_st_design: 'بالتصميم', wo_st_sent: 'عند المطبعة', wo_st_printing: 'عم ينطبع',
  wo_st_delivery: 'بالطريق للمحل', wo_st_done: 'جاهز',
  wo_open_job: 'افتح',
  wo_accept: 'اقبل',
  wo_opening: 'عم نفتح…',
  wo_reject: 'ارفض',
  wo_test_why: 'طلب التجربة ما بيصير طلب حقيقي. ارفضه لما تخلص.',
  wo_accept_needs_desk: 'لتقبل الطلب لازم يكون مكتب التوصيل مفعّل لحسابك — المالك بيفعّله من الإعدادات ← الصلاحيات.',
  perm_delivery_web: 'رؤية طلبات الموقع والرد عليها',
  wo_accepted_by: 'قبله {who} · {when}',
  wo_rejected_by: 'رفضه {who} · {when}',
  wo_open_order: 'افتح الطلب',
  wo_reject_title: 'رفض الطلب {ref}',
  wo_reject_note: 'الزبون رح يشوف السبب على صفحة طلبه بالموقع. طلبات الطباعة يلي انبعتت ليالا وير ما بتنلغى من هون.',
  wo_reject_why: 'ملاحظة للمحل (اختياري)',
  wo_rejected_toast: 'انرفض الطلب {ref}.',
  wo_code_no_answer: 'ما رد على التلفون',
  wo_code_out_of_stock: 'القطعة خلصت',
  wo_code_customer_cancelled: 'الزبون لغى الطلب',
  wo_code_unpaid: 'ما وصل التحويل',
  wo_code_duplicate: 'طلب مكرّر',
  wo_code_test: 'طلب تجربة',
  wo_code_other: 'سبب تاني',
  wo_proof_title: 'إيصال التحويل — {ref}',
  wo_desk_note: 'طلب من الموقع {ref}',
  wo_desk_skipped: '{n} منتج مو معروف تركناه برّا — اسأل الزبون.',
  al_web_new: '{n} طلبات من الموقع عم تنتظر',
  al_web_new_1: 'طلب من الموقع عم ينتظر',
  set_webprint: 'سعر الطباعة على الموقع',
  set_webprint_unset: 'مو محدّد',
  set_webprint_sub: 'سعر القطعة المطبوعة (اسم ورقم على قميص) لزبائن الموقع.',
  set_webprint_label: 'سعر القطعة الوحدة بالليرة',
  set_webprint_note: 'الموقع بيعرض هالسعر، وطلبات الطباعة يلي بتجي من الموقع بتنسجّل فيه. سعر الطباعة عالكاشير منفصل.'
};
...
var STANDBY_EN = {
  ...
  /* Selling while the internet is down (phase 3, wave 1) */
  sb_off_0: 'Offline — the till works on this laptop · nothing waiting yet',
  sb_off_n: 'Offline — the till works on this laptop · {n} changes waiting for the internet',
  sb_numbers: '{n} invoice numbers left',
  sb_sending: 'The internet is back — sending {n} changes…',
  sb_back: 'All sent · the shop is on the main server again',
  sb_home: 'Back to {host}',
  sb_attention: '{n} need a person',
  err_needs_internet: 'This needs the internet. The till works offline; this opens again when the line is back.',
  err_no_offline_numbers: 'This laptop has no invoice numbers left for offline sales. Sell on the main server once the internet is back.',
  err_bad_lent_id: 'That invoice number was not lent to this laptop.',
  err_lent_taken: 'That invoice number is already a sale on the main server.',
  ob_title: 'Not sent to the main server',
  ob_intro: 'The main server refused these, or the laptop stopped while saving them. Money may have changed hands — deal with each one by hand on the main server, then put it away here.',
  ob_none: 'Nothing is waiting for a person.',
  ob_put_away: 'Put away',
  ob_k_sale: 'Sale',
  ob_k_void: 'Void',
  ob_k_attach: 'Customer on a sale',
  ob_k_cust_new: 'New customer',
  ob_k_cust_edit: 'Customer edit',
  ob_k_redeem: 'Stamp card',
  ob_k_want: 'Wanted size',
  ob_s_refused: 'Refused by the main server',
  ob_s_unsure: 'Not sure it was saved — the laptop stopped',
  ob_s_blocked: 'Waiting on a customer that was not sent',
  cv_title: 'The main server is not answering',
  cv_body: 'The internet may be down. The till keeps working on the shop laptop — from the shop’s Wi-Fi only. Sign in there with your usual password.',
  cv_go: 'Continue on the shop laptop',
  cv_wait: 'Keep waiting here',
  cv_since: 'No answer for {n} seconds',
  cv_back: 'The main server is answering again',
  al_oversold: 'Sold offline with none left: {name} {size} on {id}, {n} short — count this shelf',
  al_oversold_1: 'Sold offline with none left: {name} {size} on {id} — count this shelf',
  al_more_oversold: '{n} more sizes were sold offline with none left — {total} in total'
};
var STANDBY_AR = {
  ...
  sb_off_0: 'أوفلاين — الكاشير شغّال على هاللابتوب · ما في شي ناطر لسا',
  sb_off_n: 'أوفلاين — الكاشير شغّال على هاللابتوب · {n} تغييرات ناطرة الإنترنت',
  sb_numbers: 'باقي {n} أرقام فواتير',
  sb_sending: 'رجع الإنترنت — عم نبعت {n} تغييرات…',
  sb_back: 'انبعت كل شي · المحل رجع على السيرفر الرئيسي',
  sb_home: 'ارجع على {host}',
  sb_attention: '{n} بدها حدا يشوفها',
  err_needs_internet: 'هاد بدو إنترنت. الكاشير شغّال أوفلاين؛ هاد برجع يشتغل لما يرجع الخط.',
  err_no_offline_numbers: 'ما ضل أرقام فواتير للبيع أوفلاين على هاللابتوب. بيع على السيرفر الرئيسي لما يرجع الإنترنت.',
  err_bad_lent_id: 'رقم الفاتورة هاد ما انعطى لهاللابتوب.',
  err_lent_taken: 'رقم الفاتورة هاد صار بيعة على السيرفر الرئيسي.',
  ob_title: 'ما انبعتت للسيرفر الرئيسي',
  ob_intro: 'السيرفر الرئيسي رفض هدول، أو اللابتوب طفى وهو عم يحفظهن. ممكن يكون في مصاري انقبضت — عالج كل وحدة بإيدك على السيرفر الرئيسي، وبعدين شيلها من هون.',
  ob_none: 'ما في شي ناطر حدا يشوفه.',
  ob_put_away: 'شيلها',
  ob_k_sale: 'بيعة',
  ob_k_void: 'إلغاء',
  ob_k_attach: 'زبون على بيعة',
  ob_k_cust_new: 'زبون جديد',
  ob_k_cust_edit: 'تعديل زبون',
  ob_k_redeem: 'بطاقة الأختام',
  ob_k_want: 'مقاس مطلوب',
  ob_s_refused: 'رفضها السيرفر الرئيسي',
  ob_s_unsure: 'مو أكيد إنها انحفظت — اللابتوب طفى',
  ob_s_blocked: 'ناطرة زبون ما انبعت',
  cv_title: 'السيرفر الرئيسي ما عم يرد',
  cv_body: 'ممكن الإنترنت مقطوع. الكاشير بيضل شغّال على لابتوب المحل — بس من واي فاي المحل. سجّل دخول هنيك بكلمة السر العادية.',
  cv_go: 'كمّل على لابتوب المحل',
  cv_wait: 'ضل ناطر هون',
  cv_since: 'ما في رد من {n} ثانية',
  cv_back: 'السيرفر الرئيسي رجع يرد',
  al_oversold: 'انباع أوفلاين وما في منه: {name} {size} بالفاتورة {id}، ناقص {n} — عدّ هالرف',
  al_oversold_1: 'انباع أوفلاين وما في منه: {name} {size} بالفاتورة {id} — عدّ هالرف',
  al_more_oversold: '{n} مقاسات تانية انباعت أوفلاين وما في منها — {total} إجمالاً'
};
...
/* ---- payment methods on the website (031) ----------------------------------
   The Payment methods card: where customers send the money, the switch that
   puts a method on the website, its colour there, cash on delivery, and the
   panel that reads back what the website actually shows. `dks_wr_*` are the
   reasons lib/webcheckout.js gives, `dks_wm_*` the cloud copy's state,
   `dks_wd_*` one difference each. */
var WEBPAY_EN = {
  dks_methods_sub: 'How customers pay — at the till, at the office, and on the website.',
  dks_acc_ph_ar: 'بالعربي: شام كاش 0999 000 111 — أحمد',
  dks_cod: 'Cash on delivery on the website',
  dks_cod_sub: 'Only ever for delivery in Aleppo by our own driver, or a pickup at the shop.',
  dks_web_on: 'On the website',
  dks_web_yes: 'Customers can choose it at checkout.',
  dks_web_why_system: 'The till\'s own — never offered on the website.',
  dks_web_why_off: 'Switch the method on first.',
  dks_web_why_no_en: 'Write where customers send the money in English to show it on the website.',
  dks_web_why_no_ar: 'Write where customers send the money in Arabic to show it on the website.',
  dks_web_why_no_desk: 'Switch Office on first — a website order is accepted at the delivery office.',
  dks_web_legacy_no_ar: 'On the website now, but only in English — write it in Arabic too.',
  dks_web_legacy_no_en: 'On the website now, but only in Arabic — write it in English too.',
  wo_desk_method_gone: 'The customer paid by {m}, which the office cannot take now. Choose how it was paid before saving.',
  dks_color: 'Colour on the website',
  dks_color_none: 'No colour',
  dks_c_green: 'Green', dks_c_teal: 'Teal', dks_c_sky: 'Sky blue', dks_c_blue: 'Blue', dks_c_violet: 'Violet',
  dks_c_pink: 'Pink', dks_c_red: 'Red', dks_c_orange: 'Orange', dks_c_gold: 'Gold', dks_c_slate: 'Grey',
  dks_wp_title: 'What the website shows',
  dks_wp_checkout: 'Checkout',
  dks_wp_pay: 'Pay by transfer',
  dks_wp_none: 'No transfer methods on the website.',
  dks_wp_cod_yes: 'Cash on delivery (Aleppo) or at pickup',
  dks_wp_cod_no: 'No cash on delivery — transfer only',
  dks_wp_from_cloud: 'read from the website\'s cloud',
  dks_wp_from_draft: 'after you press Save',
  dks_wp_again: 'Check again',
  dks_wp_sending: 'Sending to the website…',
  dks_wp_checking: 'Checking the website…',
  dks_wp_unsaved: 'Unsaved changes — they reach the website when you press Save.',
  dks_wp_fail: 'Could not check the website. Try again.',
  dks_wp_not_yet: 'Not checked yet.',
  dks_wp_at: 'checked {t}',
  dks_wp_live: 'Live on the website ✓',
  dks_wp_differs: 'The website does not show this yet',
  dks_wp_cannot: 'Cannot see the website from this laptop',
  dks_wp_live_toast: 'Customers see the new payment methods now.',
  dks_saved_web: 'Saved — sending to the website…',
  dks_wr_not_configured: 'This laptop has no cloud copy set up, so it cannot see what the website shows.',
  dks_wr_no_key: 'The website key (OG_WEB_API_KEY) is not set on this laptop.',
  dks_wr_bad_key: 'The website key on this laptop is not the one the cloud knows — run npm run web:key and the line it prints.',
  dks_wr_not_installed: 'The website\'s functions are not in the cloud yet — run 030_web_orders.sql in Supabase.',
  dks_wr_old_sql: 'Run 031_web_payments.sql in the Supabase SQL editor — until then the website ignores these switches.',
  dks_wr_unreachable: 'No internet right now. The change goes up by itself when the line is back.',
  dks_wr_refused: 'The cloud refused the question.',
  dks_wr_unreadable: 'The cloud gave an answer this laptop could not read.',
  dks_wr_error: 'Something went wrong asking the cloud.',
  dks_wm_not_configured: 'The cloud copy is not set up on this laptop.',
  dks_wm_off: 'The cloud copy is switched off on this laptop, so changes here never reach the website.',
  dks_wm_refused: 'Another laptop is the shop right now — change it there.',
  dks_wm_offline: 'The cloud copy is offline and will retry by itself.',
  dks_wm_starting: 'The cloud copy is still starting — check again in a moment.',
  dks_wm_denied: 'The cloud refused the settings — see the cloud copy card under Advanced.',
  dks_wm_live_behind: 'It is on its way — check again in a few seconds.',
  dks_wd_missing: '{m} is not on the website yet',
  dks_wd_extra: '{m} is still on the website',
  dks_wd_details: '{m}: the account text is different',
  dks_wd_names: '{m}: the name is different',
  dks_wd_color: '{m}: the colour is different',
  dks_wd_order: 'The order of the methods is different',
  dks_wd_cod: 'Cash on delivery is different',
  nav_payments: 'Payment methods',
  pay_stat_active: 'switched on',
  pay_stat_web: 'on the website',
  pay_stat_cod: 'cash on delivery on the website',
  pay_on: 'On',
  pay_off: 'Off',
  pay_unsaved: 'You have changes that are not saved yet.',
  pay_all_saved: 'Everything is saved.',
  pay_loading: 'Loading the payment methods…',
  pay_link_sub: 'How customers pay, where they send the money, and what the website offers — {n} on the website now.',
  pay_open: 'Open'
};
var WEBPAY_AR = {
  dks_methods_sub: 'كيف بيدفع الزبون — عالكاشير، بالمكتب، وعالموقع.',
  dks_acc_ph_ar: 'بالعربي: شام كاش 0999 000 111 — أحمد',
  dks_cod: 'الدفع عند الاستلام عالموقع',
  dks_cod_sub: 'بس للتوصيل بحلب مع سائقنا، أو الاستلام من المحل.',
  dks_web_on: 'عالموقع',
  dks_web_yes: 'الزبون فيه يختارها وقت الطلب.',
  dks_web_why_system: 'خاصة بالكاشير — ما بتنعرض عالموقع أبداً.',
  dks_web_why_off: 'فعّل الطريقة أول شي.',
  dks_web_why_no_en: 'اكتب لوين بيحوّل الزبون بالإنكليزي لتنعرض عالموقع.',
  dks_web_why_no_ar: 'اكتب لوين بيحوّل الزبون بالعربي لتنعرض عالموقع.',
  dks_web_why_no_desk: 'فعّل المكتب أول شي — طلب الموقع بينقبل من مكتب التوصيل.',
  dks_web_legacy_no_ar: 'هي عالموقع هلّق بس بالإنكليزي — اكتبها بالعربي كمان.',
  dks_web_legacy_no_en: 'هي عالموقع هلّق بس بالعربي — اكتبها بالإنكليزي كمان.',
  wo_desk_method_gone: 'الزبون دفع بـ {m}، والمكتب ما عاد يقبلها هلّق. اختار كيف اندفع قبل الحفظ.',
  dks_color: 'اللون عالموقع',
  dks_color_none: 'بلا لون',
  dks_c_green: 'أخضر', dks_c_teal: 'فيروزي', dks_c_sky: 'سماوي', dks_c_blue: 'أزرق', dks_c_violet: 'بنفسجي',
  dks_c_pink: 'زهري', dks_c_red: 'أحمر', dks_c_orange: 'برتقالي', dks_c_gold: 'دهبي', dks_c_slate: 'رمادي',
  dks_wp_title: 'شو بيعرض الموقع',
  dks_wp_checkout: 'إتمام الطلب',
  dks_wp_pay: 'الدفع بتحويل',
  dks_wp_none: 'ما في طرق تحويل عالموقع.',
  dks_wp_cod_yes: 'كاش عند الاستلام (حلب) أو بالمحل',
  dks_wp_cod_no: 'ما في دفع عند الاستلام — تحويل بس',
  dks_wp_from_cloud: 'مقروء من سحابة الموقع',
  dks_wp_from_draft: 'بعد ما تكبس حفظ',
  dks_wp_again: 'تأكد كمان مرة',
  dks_wp_sending: 'عم نبعت للموقع…',
  dks_wp_checking: 'عم نتأكد من الموقع…',
  dks_wp_unsaved: 'في تعديلات ما انحفظت — بتوصل للموقع لما تكبس حفظ.',
  dks_wp_fail: 'ما قدرنا نتأكد من الموقع. جرّب كمان مرة.',
  dks_wp_not_yet: 'لسا ما تأكدنا.',
  dks_wp_at: 'تأكدنا {t}',
  dks_wp_live: 'صار عالموقع ✓',
  dks_wp_differs: 'الموقع لسا ما عم يعرض هاد',
  dks_wp_cannot: 'هاللابتوب ما عم يقدر يشوف الموقع',
  dks_wp_live_toast: 'الزبائن صاروا يشوفوا طرق الدفع الجديدة.',
  dks_saved_web: 'انحفظ — عم نبعته للموقع…',
  dks_wr_not_configured: 'هاللابتوب ما عليه نسخة سحابية، فما بيقدر يشوف شو بيعرض الموقع.',
  dks_wr_no_key: 'مفتاح الموقع (OG_WEB_API_KEY) مو محطوط على هاللابتوب.',
  dks_wr_bad_key: 'مفتاح الموقع على هاللابتوب مو نفس يلي بتعرفه السحابة — شغّل npm run web:key والسطر يلي بيطبعه.',
  dks_wr_not_installed: 'وظائف الموقع لسا مو بالسحابة — شغّل 030_web_orders.sql بـ Supabase.',
  dks_wr_old_sql: 'شغّل 031_web_payments.sql بمحرر SQL تبع Supabase — لحتى تشغّله الموقع ما بيشوف هالمفاتيح.',
  dks_wr_unreachable: 'ما في إنترنت هلّق. التعديل بيطلع لحاله لما يرجع الخط.',
  dks_wr_refused: 'السحابة رفضت السؤال.',
  dks_wr_unreadable: 'السحابة ردّت شي ما قدر هاللابتوب يقراه.',
  dks_wr_error: 'صار في مشكلة وقت سألنا السحابة.',
  dks_wm_not_configured: 'النسخة السحابية مو مضبوطة على هاللابتوب.',
  dks_wm_off: 'النسخة السحابية مطفية على هاللابتوب، فالتعديلات من هون ما بتوصل للموقع أبداً.',
  dks_wm_refused: 'في لابتوب تاني هو المحل هلّق — عدّل من هنيك.',
  dks_wm_offline: 'النسخة السحابية مقطوعة، ورح تعيد المحاولة لحالها.',
  dks_wm_starting: 'النسخة السحابية لسا عم تشتغل — تأكد كمان شوي.',
  dks_wm_denied: 'السحابة رفضت الإعدادات — شوف بطاقة النسخة السحابية بالمتقدم.',
  dks_wm_live_behind: 'عم توصل — تأكد كمان كم ثانية.',
  dks_wd_missing: '{m} لسا مو عالموقع',
  dks_wd_extra: '{m} لسا عالموقع',
  dks_wd_details: '{m}: نص الحساب مختلف',
  dks_wd_names: '{m}: الاسم مختلف',
  dks_wd_color: '{m}: اللون مختلف',
  dks_wd_order: 'ترتيب الطرق مختلف',
  dks_wd_cod: 'الدفع عند الاستلام مختلف',
  nav_payments: 'طرق الدفع',
  pay_stat_active: 'مفعّلة',
  pay_stat_web: 'عالموقع',
  pay_stat_cod: 'الدفع عند الاستلام عالموقع',
  pay_on: 'شغّال',
  pay_off: 'مطفي',
  pay_unsaved: 'في تعديلات لسا ما انحفظت.',
  pay_all_saved: 'كل شي محفوظ.',
  pay_loading: 'عم نحمّل طرق الدفع…',
  pay_link_sub: 'كيف بيدفع الزبون، لوين بيحوّل، وشو بيعرض الموقع — {n} عالموقع هلّق.',
  pay_open: 'افتح'
};
Object.keys(WEBPAY_EN).forEach(function (k) { I18N.en[k] = WEBPAY_EN[k]; });
Object.keys(WEBPAY_AR).forEach(function (k) { I18N.ar[k] = WEBPAY_AR[k]; });

/* ---- 066: a colour's photos — the model, the product, and more ----------
   js/photos.js. The owner's rule: two photos per colour before the website
   shows it, the model first. Every key is in both blocks. */
var PHOTOS_EN = {
  ph_title: 'Photos',
  ph_manage: 'Photos',
  ph_done: 'Done',
  ph_slot_model: 'Model',
  ph_slot_product: 'Product',
  ph_need_model: 'the model photo',
  ph_need_product: 'the product photo',
  ph_missing: 'Still needs',
  ph_ready: 'Ready for the website',
  ph_ready_sub: 'This colour shows on the website: the model photo first, then the product, then the rest.',
  ph_ready_off: 'This product is switched off the website, so nobody sees them yet.',
  ph_rule: 'A colour goes on the website once it has both. The shop can still sell it.',
  ph_colours_ready: '{n} of {m} colours have both photos',
  ph_web_waiting: 'Waiting for photos',
  ph_web_some: '{n} colour(s) waiting for photos',
  ph_on_web: 'On the website',
  ph_off_web: 'Not on the website',
  ph_add_btn: 'Add photos',
  ph_edit_btn: 'Photos',
  ph_pick_model: 'Add the model photo',
  ph_pick_model_sub: 'somebody wearing it — shown first',
  ph_pick_product: 'Add the product photo',
  ph_pick_product_sub: 'the product on its own — shown second',
  ph_add_more: 'Add more photos',
  ph_add_more_sub: 'other angles, details — optional',
  ph_sizes_note: 'Each photo is kept twice: large for the website and small for the till. A photo straight from the phone camera is fine.',
  ph_sending: 'Sending…',
  ph_sending_n: 'Sending {n} photo(s)…',
  ph_replace: 'Replace',
  ph_as_model: 'Make this the model photo',
  ph_as_product: 'Make this the product photo',
  ph_earlier: 'Move earlier',
  ph_later: 'Move later',
  ph_remove: 'Remove',
  ph_remove_sure: 'Press again to remove',
  ph_not_saved: 'The photo was not saved.',
  ph_saved_1: 'Photo saved',
  ph_saved_n: '{n} photos saved',
  ph_some_failed: '{n} photo(s) did not save — add them from the product’s drawer.',
  ph_err_no_cloud: 'Photos need the cloud (Supabase), and it is not set up on this server.',
  ph_err_too_many: 'A colour holds at most {n} extra photos.',
  ph_err_big: 'That photo is too big to send, even shrunk. Try another.',
  ph_err_size: 'That photo is too large — 30 MB is the limit.',
  ph_form_hint: 'first somebody wearing it, then the product — both needed for the website',
  ph_f_all: 'All',
  ph_f_missing: 'Needs photos',
  ph_f_ready: 'Photos done',
  ph_photo_n: 'Photo {n}',
  ph_prev: 'Previous photo',
  ph_next: 'Next photo',
  ph_open_full: 'Open the photo at full size',
  ph_none_yet: 'No photos yet'
};
var PHOTOS_AR = {
  ph_title: 'الصور',
  ph_manage: 'الصور',
  ph_done: 'تمام',
  ph_slot_model: 'موديل',
  ph_slot_product: 'المنتج',
  ph_need_model: 'صورة الموديل',
  ph_need_product: 'صورة المنتج',
  ph_missing: 'ناقصها',
  ph_ready: 'جاهزة للموقع',
  ph_ready_sub: 'هاللون بيطلع عالموقع: صورة الموديل أول شي، بعدين المنتج، بعدين الباقي.',
  ph_ready_off: 'هالمنتج مطفي عن الموقع، فلسا ما حدا عم يشوفها.',
  ph_rule: 'اللون بيطلع عالموقع بس يصير عنده الصورتين. المحل فيه يبيعه عادي.',
  ph_colours_ready: '{n} من {m} ألوان عندها الصورتين',
  ph_web_waiting: 'ناطر الصور',
  ph_web_some: '{n} لون ناطر الصور',
  ph_on_web: 'عالموقع',
  ph_off_web: 'مو عالموقع',
  ph_add_btn: 'ضيف صور',
  ph_edit_btn: 'الصور',
  ph_pick_model: 'ضيف صورة الموديل',
  ph_pick_model_sub: 'حدا لابسه — بتطلع أول شي',
  ph_pick_product: 'ضيف صورة المنتج',
  ph_pick_product_sub: 'المنتج لحاله — بتطلع تاني وحدة',
  ph_add_more: 'ضيف صور كمان',
  ph_add_more_sub: 'من زوايا تانية، تفاصيل — مو ضروري',
  ph_sizes_note: 'كل صورة بتنحفظ مرتين: كبيرة للموقع وصغيرة للكاشير. صورة من كاميرا الموبايل مباشرة بتمشي.',
  ph_sending: 'عم تنبعت…',
  ph_sending_n: 'عم نبعت {n} صورة…',
  ph_replace: 'بدّلها',
  ph_as_model: 'خليها صورة الموديل',
  ph_as_product: 'خليها صورة المنتج',
  ph_earlier: 'قدّمها',
  ph_later: 'أخّرها',
  ph_remove: 'شيلها',
  ph_remove_sure: 'اكبس كمان مرة لتنشال',
  ph_not_saved: 'الصورة ما انحفظت.',
  ph_saved_1: 'انحفظت الصورة',
  ph_saved_n: 'انحفظت {n} صور',
  ph_some_failed: '{n} صورة ما انحفظت — ضيفها من صفحة المنتج.',
  ph_err_no_cloud: 'الصور بدها السحابة (Supabase)، وهي مو مضبوطة على هالسيرفر.',
  ph_err_too_many: 'اللون الواحد بياخد {n} صور إضافية بالأكتر.',
  ph_err_big: 'الصورة كبيرة كتير حتى بعد التصغير. جرّب غيرها.',
  ph_err_size: 'الصورة كبيرة كتير — الحد ٣٠ ميغا.',
  ph_form_hint: 'أول شي حدا لابسه، بعدين المنتج — التنتين لازمين للموقع',
  ph_f_all: 'الكل',
  ph_f_missing: 'ناقصها صور',
  ph_f_ready: 'صورها كاملة',
  ph_photo_n: 'صورة {n}',
  ph_prev: 'الصورة السابقة',
  ph_next: 'الصورة التالية',
  ph_open_full: 'افتح الصورة بحجمها الكامل',
  ph_none_yet: 'لسا ما في صور'
};
Object.keys(PHOTOS_EN).forEach(function (k) { I18N.en[k] = PHOTOS_EN[k]; });
Object.keys(PHOTOS_AR).forEach(function (k) { I18N.ar[k] = PHOTOS_AR[k]; });

/* ---- the exchange-rate feed (Settings → Exchange rate; FxFeedUI) -------- */
var FXFEED_EN = {
  fxf_title: 'Live feed',
  fxf_sub: 'The rate follows the market by itself. The website’s checkout reads the same number from the cloud copy within seconds.',
  fxf_not_configured: 'No feed key on this server (OG_FX_KEY in server/.env), so the rate is whatever is typed above.',
  fxf_loading: 'The feed is still starting up — asked again in a minute.',
  fxf_unreachable: 'Cannot reach the feed right now.',
  fxf_refused: 'The feed refused this server’s key.',
  fxf_bad: 'The feed answered, but not with a dollar rate.',
  fxf_write_failed: 'The feed answered, but the rate could not be saved.',
  fxf_never: 'Not asked yet.',
  fxf_says: 'The feed says 1 USD = {sell} sell · {buy} buy (old lira), {ago}',
  fxf_makes: 'For the shop that is 1 USD = {rate} SYP ({side} ÷ {scale})',
  fxf_same: 'The shop is on this rate.',
  fxf_would: 'The shop is at {current}; the feed would set {rate}.',
  fxf_held: 'HELD — the feed says {rate} and the shop is at {current}, a {pct}% jump, more than the guard allows. Nothing changed. Use it only if the market really moved.',
  fxf_use: 'Use {rate} now',
  fxf_check: 'Check now',
  fxf_checking: 'Checking…',
  fxf_on: 'Follow the feed automatically',
  fxf_on_sub: 'Off, the card still shows the feed and offers the button, and nothing is written by itself.',
  fxf_side: 'Which rate',
  fxf_side_sell: 'Sell (what the shop pays)',
  fxf_side_buy: 'Buy (what the shop gets)',
  fxf_side_mid: 'Midway',
  fxf_minutes: 'Check every (minutes)',
  fxf_scale: 'Old lira ÷ (the feed’s scale)',
  fxf_jump: 'Hold a jump bigger than (%)',
  fxf_last: 'Last set from the feed: 1 USD = {rate} SYP, {ago}',
  fxf_next: 'Next check in {n} min',
  fxf_typed_note: 'A rate typed above is used at once — and replaced at the feed’s next check while the feed is on.',
  fxf_toast: 'Exchange rate updated',
  fxf_toast_feed: '1 USD = {rate} SYP · from the live feed',
  fxf_toast_hand: '1 USD = {rate} SYP · from the feed, applied by hand',
  fxf_ago_now: 'just now',
  fxf_ago_min: '{n} min ago',
  fxf_ago_h: '{n} h ago',
  fxf_ago_d: '{n} days ago'
};
var FXFEED_AR = {
  fxf_title: 'المصدر المباشر',
  fxf_sub: 'سعر الصرف بيتحدّث لحالو من السوق. صفحة الدفع بالموقع بتقرا نفس الرقم من النسخة السحابية خلال ثواني.',
  fxf_not_configured: 'ما في مفتاح للمصدر على هالسيرفر (OG_FX_KEY بملف server/.env)، فالسعر هو يلي مكتوب فوق.',
  fxf_loading: 'المصدر لسا عم يشتغل — رح نسأل مرة تانية بعد دقيقة.',
  fxf_unreachable: 'ما عم نقدر نوصل للمصدر هلق.',
  fxf_refused: 'المصدر رفض مفتاح هالسيرفر.',
  fxf_bad: 'المصدر جاوب، بس مو بسعر الدولار.',
  fxf_write_failed: 'المصدر جاوب، بس ما قدرنا نحفظ السعر.',
  fxf_never: 'لسا ما سألنا.',
  fxf_says: 'المصدر بيقول ١ دولار = {sell} مبيع · {buy} شراء (ليرة قديمة)، {ago}',
  fxf_makes: 'يعني للمحل ١ دولار = {rate} ل.س ({side} ÷ {scale})',
  fxf_same: 'المحل على هالسعر.',
  fxf_would: 'المحل على {current}؛ المصدر رح يحطّه {rate}.',
  fxf_held: 'موقوف — المصدر بيقول {rate} والمحل على {current}، قفزة {pct}٪، أكتر من المسموح. ما تغيّر شي. استعمله بس إذا السوق فعلاً تحرّك.',
  fxf_use: 'استعمل {rate} هلق',
  fxf_check: 'افحص هلق',
  fxf_checking: 'عم نفحص…',
  fxf_on: 'تابع المصدر تلقائياً',
  fxf_on_sub: 'لو مطفّي، البطاقة بتضل تعرض المصدر وبتعطيك الزر، وما بينكتب شي لحالو.',
  fxf_side: 'أي سعر',
  fxf_side_sell: 'مبيع (يلي بيدفعه المحل)',
  fxf_side_buy: 'شراء (يلي بياخده المحل)',
  fxf_side_mid: 'الوسط',
  fxf_minutes: 'افحص كل (دقيقة)',
  fxf_scale: 'ليرة قديمة ÷ (مقياس المصدر)',
  fxf_jump: 'وقّف أي قفزة أكبر من (٪)',
  fxf_last: 'آخر سعر من المصدر: ١ دولار = {rate} ل.س، {ago}',
  fxf_next: 'الفحص الجاي بعد {n} دقيقة',
  fxf_typed_note: 'السعر يلي بتكتبه فوق بينطبق فوراً — وبيتبدّل بالفحص الجاي طالما المصدر شغّال.',
  fxf_toast: 'تحدّث سعر الصرف',
  fxf_toast_feed: '١ دولار = {rate} ل.س · من المصدر المباشر',
  fxf_toast_hand: '١ دولار = {rate} ل.س · من المصدر، بالضغط باليد',
  fxf_ago_now: 'هلق',
  fxf_ago_min: 'قبل {n} دقيقة',
  fxf_ago_h: 'قبل {n} ساعة',
  fxf_ago_d: 'قبل {n} يوم'
};
...
/* ---- "Waiting for the shop" (js/requests.js): what staff left at /night
   while the shop was shut. Night mode's own pages carry their own words
   (vps/og-bridge/src/night-page.js) — they are served by another machine. */
var NIGHTREQ_EN = {
  nav_requests: 'Waiting for the shop',
  rq_title: 'Waiting for the shop',
  rq_sub: 'Requests left in night mode while the shop was shut — none of them is an order yet.',
  rq_refresh: 'Refresh',
  rq_loading: 'Loading the requests…',
  rq_empty: 'Nothing is waiting.',
  rq_empty_why: 'Requests left at night arrive here by themselves.',
  rq_known: 'Known customer',
  rq_new_customer: 'New customer',
  rq_pickup: 'Collects it from the shop',
  rq_delivery: 'Delivery',
  rq_gone: 'No longer sold here',
  rq_none_here: 'None in {wh}',
  rq_only_here: 'Only {n} in {wh}',
  rq_have_here: '{wh}: {n}',
  rq_total: 'Total',
  rq_src_night: 'Night',
  rq_src_web: 'Website',
  rq_by: 'by {user}',
  rq_cannot: 'A size is no longer sold here — turn it down, or call the customer.',
  rq_capped: 'Showing the oldest {shown} of {total} waiting. The rest appear as these are decided.',
  rq_no_address: 'They asked to pick it up, so there is no address for our driver. To send it, open it in the order desk and add one.',
  err_needs_address: 'This request has no address — open it in the order desk to add one.',
  rq_accept: 'Accept',
  rq_open_desk: 'Open in the order desk',
  rq_more: 'More',
  rq_reject: 'Turn it down',
  rq_decided: 'Decided',
  rq_accepted: 'Accepted',
  rq_rejected: 'Turned down',
  rq_unsent: 'not yet sent back to night mode',
  rq_how: 'How it reaches them',
  rq_m_pickup: 'They collect it',
  rq_m_driver: 'Our driver',
  rq_fee: 'Delivery fee',
  rq_fee_list: 'Blank means the price list: {fee}',
  rq_fee_none: 'The price list has no price for this city. Type one, or leave it blank for none.',
  rq_from: 'Packed from',
  rq_will_pickup: 'This makes an order for {name}: {n} pieces, collected from the shop and paid there. The stock is checked now.',
  rq_will_driver: 'This makes an order for {name}: {n} pieces, taken by our driver and paid at the door. The stock is checked now.',
  rq_will_pickup_1: 'This makes an order for {name}: 1 piece, collected from the shop and paid there. The stock is checked now.',
  rq_will_driver_1: 'This makes an order for {name}: 1 piece, taken by our driver and paid at the door. The stock is checked now.',
  rq_accept_title: 'Accept {ref}',
  rq_make: 'Make the order',
  rq_making: 'Making the order…',
  rq_made: 'The order is made: {id}',
  rq_short: 'Not enough in stock: only {n} of {sku} left. Nothing was made.',
  rq_why: 'Why',
  rq_reject_title: 'Turn down {ref}',
  rq_reject_sub: 'Whoever left it sees the reason in night mode.',
  rq_note: 'A note (they will see it)',
  rq_pick_reason: 'Choose a reason first.',
  rq_rejected_toast: '{ref} turned down.',
  rq_reason_out_of_stock: 'Out of stock',
  rq_reason_no_answer: 'Could not reach the customer',
  rq_reason_customer_cancelled: 'The customer cancelled',
  rq_reason_duplicate: 'Already ordered',
  rq_reason_wrong_details: 'The details were wrong',
  rq_reason_other: 'Another reason',
  al_requests_waiting: '{n} night requests are waiting for the shop',
  al_requests_waiting_1: 'A night request is waiting for the shop',
  dk_from_request_title: 'Open {ref} in the order desk',
  dk_from_request_yes: 'Replace it with the request',
  dk_from_request: '{ref} is filled in — choose how it travels, then Save.',
  err_decided: 'Somebody already decided this request.',
  err_needs_customer_write: 'This is a new customer, and your account cannot add customers — ask somebody who can.',
  err_unknown_sku: 'A size in this request is no longer sold here.',
  err_bad_method: 'A transport office, a courier or abroad is paid before sending — open it in the order desk.',
  err_bad_code: 'Choose a reason.',
  err_bad_fee: 'The fee is a whole amount, and not negative.'
};
var NIGHTREQ_AR = {
  nav_requests: 'بانتظار المحل',
  rq_title: 'بانتظار المحل',
  rq_sub: 'طلبات انتركت بوضع الليل وقت كان المحل مسكّر — ولا وحدة منها صارت طلب لسا.',
  rq_refresh: 'حدّث',
  rq_loading: 'عم نجيب الطلبات…',
  rq_empty: 'ما في شي ناطر.',
  rq_empty_why: 'الطلبات اللي بتنترك بالليل بتوصل لهون لحالها.',
  rq_known: 'زبون معروف',
  rq_new_customer: 'زبون جديد',
  rq_pickup: 'بياخده من المحل',
  rq_delivery: 'توصيل',
  rq_gone: 'ما عاد ينباع هون',
  rq_none_here: 'ما في منه بـ{wh}',
  rq_only_here: 'بـ{wh} بس {n}',
  rq_have_here: '{wh}: {n}',
  rq_total: 'المجموع',
  rq_src_night: 'ليل',
  rq_src_web: 'الموقع',
  rq_by: 'من {user}',
  rq_cannot: 'في قياس ما عاد ينباع هون — ارفضه، أو احكي الزبون.',
  rq_capped: 'المعروض أقدم {shown} من أصل {total} ناطرين. الباقي بيطلعوا لمّا ينقرر بهدول.',
  rq_no_address: 'طلبوا ياخدوه من المحل، فما في عنوان لموصّلنا. لتبعته، افتحه بمكتب التوصيل وضيف عنوان.',
  err_needs_address: 'هالطلب ما إله عنوان — افتحه بمكتب التوصيل لتضيف واحد.',
  rq_accept: 'اقبله',
  rq_open_desk: 'افتحه بمكتب التوصيل',
  rq_more: 'المزيد',
  rq_reject: 'ارفضه',
  rq_decided: 'اللي انقرر',
  rq_accepted: 'انقبل',
  rq_rejected: 'انرفض',
  rq_unsent: 'لسا ما رجع خبره لوضع الليل',
  rq_how: 'كيف بيوصله',
  rq_m_pickup: 'بياخده من المحل',
  rq_m_driver: 'موصّلنا',
  rq_fee: 'أجرة التوصيل',
  rq_fee_list: 'إذا فاضي منحسب من لائحة الأسعار: {fee}',
  rq_fee_none: 'ما في سعر لهالمدينة بلائحة الأسعار. اكتب سعر، أو خليه فاضي بلا أجرة.',
  rq_from: 'بيطلع من',
  rq_will_pickup: 'هيك بيصير طلب لـ{name}: {n} قطعة، بياخدها من المحل وبيدفع هنيك. البضاعة بتنفحص هلأ.',
  rq_will_driver: 'هيك بيصير طلب لـ{name}: {n} قطعة، بياخدها موصّلنا وبتندفع عالباب. البضاعة بتنفحص هلأ.',
  rq_will_pickup_1: 'هيك بيصير طلب لـ{name}: قطعة وحدة، بياخدها من المحل وبيدفع هنيك. البضاعة بتنفحص هلأ.',
  rq_will_driver_1: 'هيك بيصير طلب لـ{name}: قطعة وحدة، بياخدها موصّلنا وبتندفع عالباب. البضاعة بتنفحص هلأ.',
  rq_accept_title: 'اقبل {ref}',
  rq_make: 'اعمل الطلب',
  rq_making: 'عم نعمل الطلب…',
  rq_made: 'صار الطلب: {id}',
  rq_short: 'البضاعة مو كفاية: باقي بس {n} من {sku}. ما انعمل شي.',
  rq_why: 'ليش',
  rq_reject_title: 'ارفض {ref}',
  rq_reject_sub: 'اللي تركه بيشوف السبب بوضع الليل.',
  rq_note: 'ملاحظة (بيشوفها)',
  rq_pick_reason: 'اختار سبب أول.',
  rq_rejected_toast: 'انرفض {ref}.',
  rq_reason_out_of_stock: 'خلصت البضاعة',
  rq_reason_no_answer: 'ما قدرنا نحكي الزبون',
  rq_reason_customer_cancelled: 'الزبون لغى',
  rq_reason_duplicate: 'في طلب قبله',
  rq_reason_wrong_details: 'المعلومات غلط',
  rq_reason_other: 'سبب تاني',
  al_requests_waiting: '{n} طلبات ليلية ناطرة المحل',
  al_requests_waiting_1: 'في طلب ليلي ناطر المحل',
  dk_from_request_title: 'افتح {ref} بمكتب التوصيل',
  dk_from_request_yes: 'حط الطلب مكانه',
  dk_from_request: 'انملى {ref} — اختار كيف بيوصل، وبعدين احفظ.',
  err_decided: 'حدا قرّر بهالطلب قبل.',
  err_needs_customer_write: 'هاد زبون جديد، وحسابك ما فيه يضيف زبائن — اطلب من حدا فيه.',
  err_unknown_sku: 'في قياس بهالطلب ما عاد ينباع هون.',
  err_bad_method: 'مكتب النقل وشركة الشحن وبرّا البلد بيندفعوا قبل الإرسال — افتحه بمكتب التوصيل.',
  err_bad_code: 'اختار سبب.',
  err_bad_fee: 'الأجرة رقم صحيح، ومو بالسالب.'
};
Object.keys(NIGHTREQ_EN).forEach(function (k) { I18N.en[k] = NIGHTREQ_EN[k]; });
Object.keys(NIGHTREQ_AR).forEach(function (k) { I18N.ar[k] = NIGHTREQ_AR[k]; });
