...
var I18N = {
  en: {
    ...
    l60_shelf_title: 'Shelf labels', l60_product_title: 'Product labels',
    ...
    l60_no_stock: 'None of these sizes are in stock at this warehouse.',
    l60_no_shelf_yet: '{n} size(s) have no shelf yet — those labels print without one.',
    ...
    sm_grow_bays_h: 'Drag to add or remove bays', sm_grow_levels_h: 'Drag to add or remove levels',
    ...
    sm_grow_min: 'A rack keeps at least one',
    ...
    sm_room_min: 'Smallest room for these racks', sm_use_min: 'Use the minimum',
    ...
    sm_new_room: 'New room', sm_room_cfg: 'Room settings', sm_delete_room: 'Delete room',
  ...
  wh_moves_note: 'Every movement is stamped with a user, a date and the balance after it. Rows cannot be deleted — only corrected with a new movement.',
    ...
    demo_no_account: 'Nobody is signed in on this screen.', messages: 'Messages', currency: 'Currency',
    ...
    if_sold_all: 'if it all sells', bulk_title: 'Bulk action', undo: 'Undo',
    ...
    wa_none: 'Nobody is waiting for anything',
    ...
    wa_none: 'Nothing outstanding', wa_waiting_n: '{n} waiting for this',
  ...
  ar: {
    ...
    l60_shelf_title: 'ملصقات الرفوف', l60_product_title: 'ملصقات المنتج',
    ...
    l60_no_stock: 'لا يوجد من هذه القياسات شيء في هذا المستودع.',
    l60_no_shelf_yet: '{n} قياس بلا رف بعد — تُطبع ملصقاتها بدون رقم رف.',
    ...
    sm_grow_bays_h: 'اسحب لإضافة خانات أو حذفها', sm_grow_levels_h: 'اسحب لإضافة طبقات أو حذفها',
    ...
    sm_grow_min: 'يبقى في الرفّ واحدة على الأقل',
    ...
    sm_room_min: 'أصغر غرفة تتّسع لهذه الرفوف', sm_use_min: 'استخدم الحدّ الأدنى',
    ...
    sm_new_room: 'غرفة جديدة', sm_room_cfg: 'إعدادات الغرفة', sm_delete_room: 'احذف الغرفة',
  ...
  wh_moves_note: 'كل حركة مسجّلة باسم المستخدم والتاريخ والرصيد بعدها. لا يمكن حذف سطر — فقط إضافة حركة تصحيح.',
    ...
    demo_no_account: 'ما في حدا مسجّل دخول على هالشاشة.', messages: 'الرسائل', currency: 'العملة',
    if_sold_all: 'إذا انباع الكل', bulk_title: 'إجراء جماعي', undo: 'تراجع',
    ...
    wa_none: 'ما في شي معلّق', wa_waiting_n: '{n} مستنيين هالقياس',
    wa_tell: 'تم إبلاغه',
