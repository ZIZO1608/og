...
var I18N = {
  en: {
    ...
    sm_rack: 'Rack', sm_racks_here: 'Racks in this room', sm_no_racks: 'No racks in this room yet',
    ...
    sm_room_key: 'Room letter — it goes into every barcode',
    ...
    sm_room_empty: 'This room has no shelves yet.',
    sm_grid_setup: 'Lay out the grid', sm_rows: 'Rows', sm_cols: 'Columns',
    sm_capacity: 'Capacity (boxes)', sm_cap_hint: 'leave empty if unknown',
    sm_capacity_n: 'holds {n}',
    sm_add_row: 'Add row', sm_add_col: 'Add column',
    sm_remove_row: 'Remove row {x}', sm_remove_col: 'Remove column {x}',
  ...
  ar: {
    ...
    sm_map: 'الخريطة',
    sm_room: 'الغرفة', sm_tilt: 'الإمالة',
    ...
    sm_rack: 'رفّ', sm_racks_here: 'الرفوف في هذه الغرفة', sm_no_racks: 'لا رفوف في هذه الغرفة بعد',
    ...
    sm_room_key: 'حرف الغرفة — يدخل في كل باركود',
    ...
    sm_room_empty: 'لا رفوف في هذه الغرفة بعد.',
    sm_grid_setup: 'رتّب الشبكة', sm_rows: 'الصفوف', sm_cols: 'الأعمدة',
    sm_capacity: 'السعة (صناديق)', sm_cap_hint: 'اتركها فارغة إن لم تكن معروفة',
    sm_capacity_n: 'يتّسع لـ {n}',
    sm_add_row: 'أضف صفاً', sm_add_col: 'أضف عموداً',
    sm_remove_row: 'احذف الصف {x}', sm_remove_col: 'احذف العمود {x}',
