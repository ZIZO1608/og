...
var I18N = {
  en: {
    ...
    sm_room_edit_hint: 'Drag a rack onto a wall to move it · pull a wall to resize the room',
    sm_drag_at: 'bay {n}', sm_drag_span: 'bays {a}–{b}',
    sm_drag_slid: 'slid along to fit',
    sm_drag_floor: 'On the floor, on no wall',
    sm_drag_short: 'That wall holds only {n} bays',
    ...
    sm_wall_pos: 'Position along the wall (bays from the left)',
  ...
  ar: {
    ...
    sm_room_edit_hint: 'اسحب رفاً إلى جدار لنقله · اسحب جداراً لتغيير قياس الغرفة',
    sm_drag_at: 'الخانة {n}', sm_drag_span: 'الخانات {a}–{b}',
    sm_drag_slid: 'أُزيح ليتّسع',
    sm_drag_floor: 'على الأرض، بلا جدار',
    sm_drag_short: 'هذا الجدار يتّسع لـ {n} خانات فقط',
    ...
    sm_wall_pos: 'الموضع على الجدار (عدد الخانات من اليسار)',
